...
public class MainWindow extends JFrame {
	...
	public MainWindow(File file) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(MainWindow.class.getResource("/img/icon32.png")));
		...
		contentPane.add(toolBar_3, BorderLayout.NORTH);
				...
				toolBar.setFloatable(false);
								...
								toolBar.add(toolBar_4);
										...
										btnExportToExcel.setIcon(new ImageIcon(MainWindow.class.getResource("/img/page_white_excel.png")));
								...
								btnFind.setIcon(new ImageIcon(MainWindow.class.getResource("/img/Binoculars.gif")));
								...
								toolBar.add(toolBar_1);
										...
										btnExpandAll.setIcon(new ImageIcon(MainWindow.class
												...
												btnCollapseAll.setIcon(new ImageIcon(MainWindow.class
														.getResource("/img/CollapseAll.gif")));
														...
														btnCollapsedSubtasks.setIcon(new ImageIcon(MainWindow.class
																.getResource("/img/PartialExpand.gif")));
																...
																toolBar.add(toolBar_2);
																		...
																		btnHighlight.setIcon(new ImageIcon(MainWindow.class
																				.getResource("/img/100percent.png")));
